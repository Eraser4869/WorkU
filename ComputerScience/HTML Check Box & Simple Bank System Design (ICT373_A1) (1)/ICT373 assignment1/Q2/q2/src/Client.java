 ...
 * @date        14/10/2022
 * @author      Lee Jihu
 * // TODO: When entering paying customer, add return option to allow user to return to main menu if the
